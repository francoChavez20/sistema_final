<div class="container mt-5">
    <div class="row justify-content-center" style="background-color: #F4E5FF;">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center" style="background-color: #c88af5;">
                ...
                <div class="card-body text-center" style="background-color: #d79fff;">
                    ...
                    <a href="<?php echo BASE_URL ?>login" class="btn btn-danger btn-block">Cerrar Sesión</a>
                </div>
            </div>
        </div>
    </div>
